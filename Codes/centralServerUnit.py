# -*- coding: utf-8 -*-
import sys, socket, select, threading, thread, time, sqlite3
        ...
        while self.running == 1:
            ...
            try:
                ...
                if request == "register":                       # Register operation
                    ...
                    #print "clientPortUpdate istek geldi \n"
                    #self.connectToDatabase()
                    #time.sleep(0.3)
                    userNameAndclientPortData = str(self.conn.recv(1024))
                    #print userNameAndclientPortData
            ...
            if not userNamePasswordIpAddrAndPortData:
                ...
                if (userLogin == True):     # 'userName' ve 'password' girisi kabul edildi.
                    try:
                        ...
                        self.sendMessageToPeer(conn, "Success")
                        #self.sendMessageToPeer(conn, str(self.getAllOnlineUserRecords()))
                        break
                    except:
